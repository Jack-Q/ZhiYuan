            ...
            <div class="linkBoxWarper">
                <div class="linkBox">
                    ...
                    <a class="linkSelection" href="admitDataQuery.php">
                        <div>
                            <svg viewBox="-10 -10 120 120" width="35" height="35" version="1.1" xmlns="http://www.w3.org/2000/svg">
    ...
    <script>
        window.onload = ( function () {
            ...
            function switchToNext() {
                progress.animate( { 'width': '497px' }, 3200, 'linear', function () {
                    progress.animate( { 'width': '0' }, 800, 'linear' );
